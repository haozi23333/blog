...
//  * @type {string}
//  */
// export const GET_HAOZI_INFO = 'GET_HAOZI_INFO'
// /**
//  * 获取 haozi 的某一篇 post 的详细信息
//  * @type {string}
//  */
// export const GET_HAOZI_POST = 'GET_HAOZI_POST'
// /**
//  * 获取 haozi 的 post 列表
//  * @type {string}
//  */
...
export default {
  ...
  MOBILE_SCLOLL: 'MOBILE_SCLOLL',
  SEARCH: 'SEARCH',
  OPEN_POST: 'OPEN_POST',
  CLOSE_POST: 'CLOSE_POST',
  BODY_SCROLL: 'BODY_SCROLL',
  GET_HAOZI_INFO: 'GET_HAOZI_INFO',
  GET_HAOZI_POST: 'GET_HAOZI_POST',
  GET_POSTS: 'GET_POSTS',
  SET_POSTS: 'SET_POSTS',
  GET_HAOZI_POSTLIST: 'GET_HAOZI_POSTLIST',
  GET_POST_CATALOG: 'GET_POST_CATALOG'
}